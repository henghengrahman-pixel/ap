...
router.post('/settings', auth, (req, res) => {
  ...
  const data = {
    ...
    mainWebviewUrl: req.body.mainWebviewUrl || old.mainWebviewUrl || 'https://omtogelblue.com/',
    bottomMenuUrl: req.body.bottomMenuUrl || old.bottomMenuUrl || req.body.mainWebviewUrl || '#',
    ...
    accentColor: req.body.accentColor || '#111111'
  };
